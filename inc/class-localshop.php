...
if ( ! class_exists( 'Localshop' ) ) :
	...
	class Localshop {
       ...
       * Fonts
       */
      // $google_fonts = apply_filters( 'localshop_google_font_families', array(
		...
		public function print_embed_styles() {
			...
			<style type="text/css">
				.wp-embed {
					...
					background-color: <?php echo localshop_adjust_color_brightness( $background_color, -7 ); ?> !important;
				}
