...
( function() {
  ...
  jQuery( window ).load( function() {
    jQuery( '.localshop-handheld-footer-bar .search > a' ).click( function(e) {
  ...
  jQuery( '.main-navigation, .secondary-navigation' ).find( 'a' ).on( 'focus.localshop blur.localshop', function() {
    jQuery( this ).parents().toggleClass( 'focus' );
  });

  // Add focus to cart dropdown
  jQuery( window ).load( function() {
    jQuery( '.site-header-cart' ).find( 'a' ).on( 'focus.localshop blur.localshop', function() {
      jQuery( this ).parents().toggleClass( 'focus' );
    });
  });
